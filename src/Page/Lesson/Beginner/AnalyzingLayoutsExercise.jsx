...
const QuoteBox1 = ({text, author, bio}) => {
	return (
		...
		"
			>
				<div className="mb-1 text-cyan-700 text-lg">{author}</div>
...
const QuoteBox2 = ({text, author, bio}) => {
	return (
		...
		"
			>
				<div className="text-white text-lg mb-2">{author}</div>
				<div className="text-xs text-blue-300">{bio}</div>
			</div>
			<div
				className="
			w-64
...
const QuoteBox3 = ({text, author, bio}) => {
	return (
		...
		"
			>
				<div className="text-rose-700 text-sm">{author}</div>
				<div className="text-rose-500 text-xs">{bio}</div>
			</div>
		</div>
	)
}
