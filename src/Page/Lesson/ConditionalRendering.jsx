...
const Widget1 = () => {
	...
	">
		<button onClick={(e) => setReveal(!reveal)} className="px-4 py-2 bg-teal-500 text-white rounded-full">click me</button>
...
const Widget3 = () => {
	...
	">
		...
		<button onClick={(e) => setToggle(!toggle)} className='px-4 py-2 bg-fuchsia-500 text-white rounded-full'>click me</button>
	</div>
}

const ConditionalRendering = () => {
	
	return <div className="h-full flex flex-col flex justify-start items-center gap-y-4 font-noto">
		<Widget1 />
		<Widget2 />
		<Widget3 />
	</div>
