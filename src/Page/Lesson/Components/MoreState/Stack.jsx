...
export default ({children, show = true}) => {
	...
	return (
		<div className="flex flex-col justify-end items-center">
			<div className="h-[280px] flex flex-col justify-end">{stack}</div>
			...
			<div className="w-full flex flex-row gap-x-2 justify-stretch items-end border-t p-4">
				<div className="grow basis-0 flex justify-end">
					<button
						className="p-2 font-bold bg-yellow-300 rounded-lg"
						onClick={(e) => setSize(remove(size))}
					>
						Remove
					</button>
				</div>
				<div className="grow basis-0 flex justify-start">
					<button
						className="p-2 font-bold bg-green-300 rounded-lg"
						onClick={(e) => setSize(add(size))}
					>
						Add
					</button>
				</div>
