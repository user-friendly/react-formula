		...
		<div className="max-w-2xl m-4">
			<div className="mb-4 flex">
				...
				<div className="ml-4 text-lg flex flex-col justify-evenly">
					...
					<div>
						<span className="inline-block w-32 font-bold">Nickname</span>{' '}
						{nickname}
					</div>

					<div>
						<span className="inline-block w-32 font-bold">Capital</span>{' '}
						{capital}
					</div>

					<div>
						<span className="inline-block w-32 font-bold">Population</span>{' '}
...
const ErrorMessage = ({error}) => {
	...
	return (
		<div className="m-2 px-4 py-2 bg-rose-200 text-xl rounded-lg shadow-lg">
			⚠{' '}
...
export default () => {
	...
	return (
		<div className="my-4 flex flex-col items-center">
			<Form
				className="mb-4 text-lg flex justify-center"
			...
			>
				<div className="relative">
					...
					<button
						type="button"
						className="absolute top-2 right-6 opacity-20 hover:opacity-100 focus:opacity-100"
						onClick={handleClear}
					>
						❌
					</button>
				...
				<input
					className="px-4 rounded-lg bg-teal-400 text-teal-800 cursor-pointer"
					type="submit"
					value="Search"
				/>
			</Form>
